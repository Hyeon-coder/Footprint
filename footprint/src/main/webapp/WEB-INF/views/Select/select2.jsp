...
<link rel="stylesheet" href="resources/style/select/select2.css" />
	...
	<div class="select2_content_all">
    	<div class="select2_emotion">
	   			...
	   			<input type="button" value="기분에 맞춰 추천" onclick="location.href='/Project/2~9page/select2_1.jsp'" />
	   	</div>
	   	<div class="select2_distance">
	    		...
	    		<input type="button" value="거리에 맞춰 추천" onclick="location.href='/Project/2~9page/select2_2.jsp'" />
	   	</div> 
	   	<div class="select2_time">
	    		...
	    		<input type="button" value="시간에 맞춰 추천" onclick="location.href='/Project/2~9page/select2_3.jsp'" />
	   	</div> 
    </div>
